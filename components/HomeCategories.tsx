...
const HomeCategories = ({ categories }: { categories: Category[] }) => {
  return (
    <div className='bg-white border border-signature/20 my-10 md:my-20 p-5 lg:p-7 rounded-md'>
            ...
            {categories?.map((category) => (
                ...
                className='bg-gray-100 p-5 flex items-center gap-3 group'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p className='text-sm'>
                            <span className='font-bold text-signature'>{`(${category?.productCount})`}</span>{" "}
                            items Available
                        </p>
                    </div>
                </div>
